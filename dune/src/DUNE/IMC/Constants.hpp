...
#define DUNE_IMC_CONST_GIT_INFO "2019-10-21 382aeb5  (HEAD -> ntnuOtterASV, origin/ntnuOtterASV, origin/HEAD)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "3e9024be239f96addae90c415a6be345"
