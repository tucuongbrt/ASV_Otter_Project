  ...
  namespace ClockPPS
  {
    ...
    struct Task: public DUNE::Tasks::Task
    {
        ...
        m_pps(NULL)
      {
        ...
        param("GPS Entity Label", m_args.elabel_gps)
      ...
      onResourceAcquisition(void)
      {
        ...
        {
          err(DTR("Err: %s"), e.what());
          throw RestartNeeded(e.what(), 5.0, false);
        }
        debug(DTR("success linuxpps"));
        struct timex tmx;
      ...
      consume(const IMC::GpsFix* msg)
      {
        ...
        // Only use fixes from set entity.
      ...
      computeTimeOffset(const IMC::GpsFix* msg)
      {
        ...
        if (offset != 0)
          spew("GpsFix time: %0.2f / gps: %ld / cpu_time: %ld / offset: %ld", msg->getTimeStamp(), gps_time, cpu_time, offset);
      }
